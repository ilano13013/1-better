...
export const STORES: Store[] = [
  ...
  { id: 'aldi', name: 'Aldi', priceIndex: 0.86, color: '#00447C', driveSupported: false },
  ...
  { id: 'monoprix', name: 'Monoprix', priceIndex: 1.22, color: '#F07D00', driveSupported: true },
  { id: 'autre', name: 'Autre enseigne', priceIndex: 1.0, color: '#6B7280', driveSupported: false },
];
