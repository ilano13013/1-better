...
export type { ActiveSession, CompletedWorkout, RestTimer } from '../engine/session';
import type { ActiveSession, CompletedWorkout, RestTimer } from '../engine/session';
...
export interface AppState {
  ...
  tourSeen: boolean;
  /** Durée de la séance en cours, `null` s'il n'y en a pas. */
  activeSession: ActiveSession | null;
  /** Minuteur de récupération en cours, `null` s'il n'y en a pas. */
